        ...
        <div className="relative mt-[100px] mb-5">
            ...
            <section className="my-2">
                <div className="flex gap-1">
                    ...
                    <p className="m-0 text-black">
                         An iOS app that lets users track their fasts and gain insights into their fasting habits.
                    </p>
                </div>
            ...
            */}
            ...
            <div className="columns-2 gap-4 my-4">
                ...
                <img className="mb-4 border border-gray-200 w-full" src={imageStats} alt="fastily" />
                <LoopVideo src={video1} />
                <img className="mb-4 border border-gray-200 w-full" src={imageWins} alt="fastily" />
                <img className="mb-4 border border-gray-200 w-full" src={imageStreaks} alt="fastily" />
                <img className="mb-4 border border-gray-200 w-full" src={imageNotifications} alt="fastily" />
            </div>
        </div>
    )
}
